...
const Checkout = () => {
    //{ buyer: { name, phone, email }, items: [{ id, name, price, quantity }], date, total }
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        const dia = new Date()
        const items =  Array.from(cart.values()).map(e=> {return {id:e.id,name:e.name,price:e.price,quantity:e.quantity}})        
